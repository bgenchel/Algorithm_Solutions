...
// Given a string s of length at most 10^4 over the 
// alphabet of lower case latin letters. In the first 
// line output the number k of different symbols and 
// the length l of a binary encoding. In each of the 
// next k lines output a binary code of a symbol in the 
// form "<symbol>: <code>". In the last line output the 
// encoded string. 
